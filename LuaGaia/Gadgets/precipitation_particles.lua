...
-------------------------------------------------------------------------------
--------------------------------------------------------------------------------
if (Spring.GetMapOptions().weather == "clear") then
	return
end
...
local function ColorFunc()
	local rainColorR = math.random(6,8)/10
	local rainColorG = math.random(6,8)/10
...
local particleOneTexture = 'LuaGaia/effects/snowflake.png'  -- what bitmap are we using?
...
local particleTwoTexture = 'LuaGaia/effects/snowflake.png'  -- what bitmap are we using?
...
local particleThreeTexture = 'LuaGaia/effects/snowflake.png'  -- what bitmap are we using?
